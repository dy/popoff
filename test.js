...
test('tall modal', function () {
	...
	target.style.color = 'white';
	target.style.padding = '10px';
	document.querySelectorAll('p')[5].appendChild(target);
